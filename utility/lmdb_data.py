...
root_path = '/home/jpl-ly/data/sst/Washington_DC_Mall/'  #change to datadir
...
def create_cave_31():
    print('create cave_31...')
    datadir = '/data1/jiahua/train_data/cave_mat/' # your own data address
    fns = os.listdir(datadir)
    fns = [fn.split('.')[0]+'.mat' for fn in fns]
    
    create_lmdb_train(
        datadir, fns, '/data1/jiahua/ly/train_data/train_CAVE/', 'msi',  # your own dataset address
        crop_sizes=(512, 512),
        scales=(1, 0.5, 0.25),        
        ksizes=(31, 64, 64),
...
def create_icvl64_31():
    ...
    datadir = '/data1/jiahua/train_data/train_mat/icvl_mat/' # your own data address
    fns = os.listdir(datadir)
    fns = [fn.split('.')[0]+'.mat' for fn in fns]
    
    create_lmdb_train(
        datadir, fns, '/data1/jiahua/ly/icvl_train/train', 'rad',  # your own dataset address
...
def createDCmall():
    print('create wdc...')
    datadir = '/home/jpl-ly/data/sst/Washington_DC_Mall/Hyperspectral_Project/WDC/train/'
    fns = os.listdir(datadir) 
    
    fns = [fn.split('.')[0]+'.mat' for fn in fns]
    create_lmdb_train(
        datadir, fns, '/home/jpl-ly/data/sst/Washington_DC_Mall/Hyperspectral_Project/WDC/wdc', 'data',  # your own dataset address
        crop_sizes=None,
        scales=(1, 0.5, 0.25),        
        ksizes=(191, 64, 64),
