...
def addNoiseComplex(srcdir,dstdir):
    ...
    add_Impulse_noise = Compose([
        AddNoiseNoniid(sigmas),
        AddNoiseImpulse(),
    ])
    noise_models.append(add_Impulse_noise)
    add_Deadline_noise = Compose([
        AddNoiseNoniid(sigmas),
        AddNoiseDeadline(),
    ])
    noise_models.append(add_Deadline_noise)
    add_Stripe_noise = Compose([
        AddNoiseNoniid(sigmas),
        AddNoiseStripe(),
    ])
    noise_models.append(add_Stripe_noise)
...
if __name__ == '__main__':
    srcdir = '/data1/jiahua/ly/india_test/'   #file path of original file
    dstdir = '/data1/jiahua/ly/india_test_complex/' #file path to put the testing file
